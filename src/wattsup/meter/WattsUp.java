...
import static wattsup.data.command.WattsUpCommand.CONFIGURE_EXTERNAL_LOGGING_INTERVAL;
...
import static wattsup.data.command.WattsUpCommand.STOP_LOGGING;
 ...
 * <li>Register a {@link wattsup.listener.WattsUpDataAvailableListener} listener to be notified when data (measure) are available. Call the method
...
public final class WattsUp
{
    ...
    /**
     * The scheduler used to notify the clients about data available. The interval of the notification is determined through {@link WattsUpConfig} or
     ...
     * 
     * @param listener
     *            The instance for the {@link WattsUpListener} to be registered. Might not be <code>null</code>.
     ...
     * 
     * @param listener
     *            The reference to the {@link WattsUpListener} to be removed.
     ...
     * 
     * @throws IOException
     *             If the power meter is not available.
     * @see #connect(boolean)
     * @see #reset()
     */
     ...
     * 
     * @param reset
     *            Flag to indicates if the meter should be reseted.
     * @throws IOException
     *             If the power meter is not available.
     * @see #reset()
     */
     ...
     * @throws IOException
     *             If is not possible to retrieve the data.
     */
     ...
     * 
     * @param interval
     *            The interval in seconds to configure the external logging.
     * @throws IOException
     *             If it is not possible communicating with the meter.
     */
     ...
     * 
     * @param event
     *            The reference to the {@link WattsUpEvent} to be notified. Might not be <code>null</code>.
     * @param <T>
